...
/////////////////////////////////////////////////////
    ...
    and nest together according to their associativity. 
    When two tokens declared in different precedence declarations associate, the one 
...
// my code
    ...
    formal  : OBJECTID ':' TYPEID       { $$ = formal($1, $3); }
            ...
            // expr_list can be null.  -- expr [,expr]*
    expr_list: expr_list ',' expr { $$ = append_Expressions($1, single_Expressions($3)); }
            | expr { $$ = single_Expressions($1); }
            ;

            // [expr;]+   need error handling
    expr_list2:
            expr ';' { $$ = single_Expressions($1); }
    ...
    branch_list: 
            ...
            | OBJECTID ':' TYPEID DARROW expr ';' branch_list
